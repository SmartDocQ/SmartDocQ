...
- Environment Variables:
  ...
  - MAIL_PASS = your-gmail-app-password (16-character App Password)
...
- Password reset email not received:
  - Ensure Gmail account has 2FA and you use an App Password for MAIL_PASS.
  - Some hosts block SMTP egress. The API responds immediately, but emails may fail silently; check server logs for `Forgot-password sendMail failed` errors.
  - Verify `MAIL_USER`, `MAIL_PASS`, and `FRONTEND_URL` are set correctly in your Node service env.
